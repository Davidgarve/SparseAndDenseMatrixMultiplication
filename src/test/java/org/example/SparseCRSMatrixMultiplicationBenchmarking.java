...
public class SparseCRSMatrixMultiplicationBenchmarking {
    ...
    public void setupTrial() {
        ...
        csrMatrixA = SparseMatrixCSRMul.convertToCSR(denseMatrixA);
        csrMatrixB = SparseMatrixCSRMul.convertToCSR(denseMatrixB);
    }
